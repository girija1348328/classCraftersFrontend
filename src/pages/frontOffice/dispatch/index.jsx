...
import { 
    getAllDispatchEntries, 
    createDispatchEntry, 
    updateDispatchEntry, 
    deleteDispatchEntry 
} from '../../../store/slices/frontOfficeSlice';
import { 
    selectDispatchPostal, 
...
const Dispatch = () => {
    ...
    const dispatchPostals = useSelector(selectDispatchPostal);
    const loading = useSelector(selectDispatchLoading);
    const error = useSelector(selectDispatchError);
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.referenceNo || !formData.address || !formData.fromTitle) {
        ...
        try {
            ...
            if (editingId) {
                await dispatch(updateDispatchEntry({
                    dispatchId: editingId,
                    updateData: submitData
                })).unwrap();
                toast.success('Dispatch updated successfully');
            } else {
                await dispatch(createDispatchEntry(submitData)).unwrap();
    ...
    const handleDelete = async (id) => {
        try {
            await dispatch(deleteDispatchEntry(id)).unwrap();
        ...
        <div className="w-full h-full p-4 md:p-6 bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Dispatch Management</h1>
                        <p className="text-gray-600 text-sm md:text-base mt-1">Manage postal dispatches</p>
                    </div>
                            ...
                            <div key={item.id} className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
                                <div className="flex justify-between items-start mb-3">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">From: {item.fromTitle}</p>
                                    </div>
